...
export default function Header({ user, cartCount, onLogin, onSignup, onSellerSignup, onLogout, onCartClick }) {
  return (
          ...
          {user ? (
            ...
            <>
              ...
              <button
                ...
                className="text-sm text-stone-700 border border-stone-300 hover:bg-stone-100 px-4 py-2 rounded-lg"
              >
                Become a Seller
              </button>
            </>
